...
class Cartones {
    ...
    constructor(){
        ...
        this.seriales = []
        // arreglo que contiene los cartones
        this.cartones = [];
    }

    // agrega un nuevo carton a la clase
    agregarCarton(){
        ...
        // agrega el nuevo carton al arreglo de cartones
        this.cartones.push(carton);

        return carton;
    }

    // llena la propiedad cartones con 5 nuevos objetos carton
    iniciar(){ 
